...
def run_advanced_benchmark(llm, batch_size, input_len, output_len):
    ...
    # ---------------------------------------------------------
    sp_prefill = SamplingParams(temperature=0.0, ignore_eos=True, max_tokens=1, min_tokens=1)
    ...
    # ---------------------------------------------------------
    sp_full = SamplingParams(temperature=0.0, ignore_eos=True, max_tokens=output_len, min_tokens=output_len)
